              ...
              return Container(
                ...
                child: ListTile(
                  title: Text(
                    ...
                    style: TextStyle(
                      fontWeight:
                          isCurrentChain ? FontWeight.bold : FontWeight.normal,
                    ),
                  ),
                  ...
                  onTap: isCurrentChain
                      ? null
                      : () async {
                          Navigator.pop(context);
                          await switchToChain(context, walletProvider,
...
Future<void> switchToChain(
    BuildContext context, WalletProvider walletProvider, String chainId) async {
  try {
