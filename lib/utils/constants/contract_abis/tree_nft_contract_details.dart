...
const String treeNftContractABI = '''[
    ...
    {
      "type": "function",
      "name": "getUserVerifierTokenDetails",
      "inputs": [
        {
          "name": "userAddress",
          "type": "address",
      ...
      "outputs": [
        {
          "name": "verifierTokenDetails",
          "type": "tuple[]",
          "internalType": "struct VerificationDetails[]",
          "components": [
            {
              "name": "verifier",
              "type": "address",
    ...
    {
      "type": "function",
      "name": "s_userToPlanterTokenAddress",
      "inputs": [
        {
          "name": "",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "s_userToVerifierTokenAddresses",
      "inputs": [
        {
          "name": "",
          "type": "address",
